...
namespace PptPlus
{
    public class Font
    {
        ...
        protected Sd.Color highlight = Sd.Color.Empty;
        ...
        public virtual Sd.Color Highlight
        {
        ...
        public virtual bool HasHighlight { get { return this.highlight != Sd.Color.Empty; } }
        ...
        public Font ApplyPreset( Font.Presets preset)
        {
            Font output = new Font(this);
            Font font = Fonts.GetPreset(preset);
            output.Name = font.Name + "*";
            output.Family = font.family;
            output.Size = font.size;
