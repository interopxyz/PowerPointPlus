...
{
    public class GH_PP_Con_Create_Shp_Flowchart : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Con_Create_Shape_Flowchart class.
        /// </summary>
        public GH_PP_Con_Create_Shp_Flowchart()
          : base("Powerpoint Flowchart Shape Content", "Ppt Flow Shp",
              "Construct a PowerPoint Flow Shape Content Object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (Content.ShapeFlowchart value in Enum.GetValues(typeof(Content.ShapeFlowchart)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Content.ShapeFlowchart shp = (Content.ShapeFlowchart)shape;
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Con_Shape_Flowchart;
            }
        }
        ...
        {
            get { return new Guid("42F71C78-3E23-4AE4-8677-0AD32456D620"); }
        }
    }
}