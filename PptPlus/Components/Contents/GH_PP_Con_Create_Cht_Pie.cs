...
{
    public class GH_PP_Con_Create_Cht_Pie : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Create_Chart_Pie class.
        /// </summary>
        public GH_PP_Con_Create_Cht_Pie()
          : base("Powerpoint Pie Chart Contents", "Ppt Pie Chart",
              "Construct a Powerpoint Pie Chart Content Object",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if(hasValues)content = Content.CreateChartPieContent(values, labels, name, content);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Con_Chart_Pie;
            }
        }
        ...
        {
            get { return new Guid("FFCF2666-753E-4392-A896-D344C0AD9503"); }
        }
    }
}