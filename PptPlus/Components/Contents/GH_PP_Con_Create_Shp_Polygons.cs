...
{
    public class GH_PP_Con_Create_Shp_Polygons : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Con_Create_Shape_Polygons class.
        /// </summary>
        public GH_PP_Con_Create_Shp_Polygons()
          : base("Powerpoint Polygon Shape Content", "Ppt Poly Shp",
              "Construct a PowerPoint Polygon Shape Content Object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (Content.ShapePolygons value in Enum.GetValues(typeof(Content.ShapePolygons)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
           ...
           bool hasShape = DA.GetData(1, ref shape);
            ...
            Content.ShapePolygons shp = (Content.ShapePolygons)shape;
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Con_Shape_Polygon;
            }
        }
        ...
        {
            get { return new Guid("26BFCA1C-5C16-4933-AFE3-5340774CC18A"); }
        }
    }
}