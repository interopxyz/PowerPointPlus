...
{
    public class GH_PP_Con_Create_Shp_Curves : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Con_Create_Shape_Lines class.
        /// </summary>
        public GH_PP_Con_Create_Shp_Curves()
          : base("Powerpoint Curve Shape Content", "Ppt Curve Shp",
              "Construct a PowerPoint Curve Shape Content Object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (Content.ShapeLines value in Enum.GetValues(typeof(Content.ShapeLines)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Content.ShapeLines shp = (Content.ShapeLines)shape;
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Con_Shape_Line;
            }
        }
        ...
        {
            get { return new Guid("939F9B1F-AC7A-4D4D-BCD1-DD00B44A7DC6"); }
        }
    }
}