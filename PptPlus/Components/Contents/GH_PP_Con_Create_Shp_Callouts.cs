...
{
    public class GH_PP_Con_Create_Shp_Callouts : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Con_Create_Shape_Callouts class.
        /// </summary>
        public GH_PP_Con_Create_Shp_Callouts()
          : base("Powerpoint Callout Shape Content", "Ppt Callout Shp",
              "Construct a PowerPoint Callout Shape Content Object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (Content.ShapeCallouts value in Enum.GetValues(typeof(Content.ShapeCallouts)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Content.ShapeCallouts shp = (Content.ShapeCallouts)shape;
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Con_Shape_Callout;
            }
        }
        ...
        {
            get { return new Guid("5E174692-98A3-447A-9849-6301750A713F"); }
        }
    }
}