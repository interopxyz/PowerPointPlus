...
{
    public class GH_PP_Con_Create_Shp_Equations : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Con_Create_Shape_Equations class.
        /// </summary>
        public GH_PP_Con_Create_Shp_Equations()
          : base("Powerpoint Equations Shape Content", "Ppt Equations Shp",
              "Construct a PowerPoint Equations Shape Content Object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (Content.ShapeEquations value in Enum.GetValues(typeof(Content.ShapeEquations)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Content.ShapeEquations shp = (Content.ShapeEquations)shape;
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Con_Shape_Equations;
            }
        }
        ...
        {
            get { return new Guid("D2BFA948-A84A-41F3-B040-7FD3D067BC50"); }
        }
    }
}