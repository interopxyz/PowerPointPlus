...
{
    public class GH_PP_Con_Create_Shp_Stars : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Con_Create_Shape_Stars class.
        /// </summary>
        public GH_PP_Con_Create_Shp_Stars()
          : base("Powerpoint Star Shape Content", "Ppt Star Shp",
              "Construct a PowerPoint Star Shape Content Object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("Shape", "S", "The Shape Geometry", GH_ParamAccess.item);
            ...
            foreach (Content.ShapeStars value in Enum.GetValues(typeof(Content.ShapeStars)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Content.ShapeStars shp = (Content.ShapeStars)shape;
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Con_Shape_Star;
            }
        }
        ...
        {
            get { return new Guid("824F323D-0F77-4DF8-B7FB-01C15B4EB745"); }
        }
    }
}