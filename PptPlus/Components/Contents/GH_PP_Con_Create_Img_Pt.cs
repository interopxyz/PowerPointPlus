...
{
    public class GH_PP_Con_Create_Img_Pt : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Con_Create_Image_Pt class.
        /// </summary>
        public GH_PP_Con_Create_Img_Pt()
          : base("Powerpoint Pos Image Content", "Ppt Img Pt",
              "Construct a PowerPoint Position Image Content Object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddPointParameter("Point 3d","P","The lower left hand location of the image",GH_ParamAccess.item);
            pManager[2].Optional = true;
            pManager.AddNumberParameter("Scale", "S", "The scale value of the image", GH_ParamAccess.item);
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddRectangleParameter(Constants.Boundary.Name, Constants.Boundary.NickName, Constants.Boundary.Output, GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (isValid)
            {
                ...
                Rectangle3d boundary = new Rectangle3d(plane, new Interval(0, image.Width * scale), new Interval(0, image.Height * scale));

                content = Content.CreateImageContent(image, content);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Con_Image_Plcpng;
            }
        }
        ...
        {
            get { return new Guid("DF51D12D-E3CF-4E42-9143-4D6C280E1A9F"); }
        }
    }
}