...
{
    public class GH_PP_Con_Create_Shp_Actions : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Con_Create_Shape_Actions class.
        /// </summary>
        public GH_PP_Con_Create_Shp_Actions()
          : base("Powerpoint Action Shape Content", "Ppt Action Shp",
              "Construct a PowerPoint Action Shape Content Object",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            foreach (Content.ShapeActions value in Enum.GetValues(typeof(Content.ShapeActions)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Content.ShapeActions shp = (Content.ShapeActions)shape;
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Con_Shape_Actions;
            }
        }
        ...
        {
            get { return new Guid("64B684E3-56DD-4BAD-AF3A-497767C8C415"); }
        }
    }
}