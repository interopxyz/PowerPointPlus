...
{
    public class GH_PP_Pag_ANSI : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Pag_ASCI class.
        /// </summary>
        public GH_PP_Pag_ANSI()
          : base("PowerPoint ANSI Presentation", "Ppt ANSI",
              "Create a PowerPoint Presentation from a standard ANSI Paper Size",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("Size", "S", "A standard ANSI paper size", GH_ParamAccess.item, 0);
            ...
            foreach (Page.SizesANSI value in Enum.GetValues(typeof(Page.SizesANSI)))
            {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Page page = Page.Preset((Page.SizesANSI)type);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Pag_Size_Ansi;
            }
        }
        ...
        {
            get { return new Guid("1418c111-b2f8-4af3-beab-72c72a5e9369"); }
        }
    }
}