...
{
    public class GH_PP_Pag_IsoB : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GH_PP_Pag_IsoB class.
        /// </summary>
        public GH_PP_Pag_IsoB()
          : base("PowerPoint Iso B Presentation", "Ppt IsoB",
              "Create a PowerPoint Presentation from a standard Iso B Paper Size",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Page page = Page.Preset((Page.SizesIsoB)type);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Ppt_Pag_Size_IsoB;
            }
        }
        ...
        {
            get { return new Guid("8974bb2f-4212-440a-9527-955f1da2bfb0"); }
        }
    }
}